...
Para ello, me propuse realizar una pieza funcional que supliera una faltante que tenia:
...
<figure markdown="span">
  ![Imagen de Medida Aro de Luz Monopíé 1](../images/MT02/1.png){ width="600"}
</figure>

<figure markdown="span">
  ![Imagen de Medida Aro de Luz Monopíé 2](../images/MT02/2.png){ width="600"}
</figure>

Luego tomé las medidas de la mesa donde el soporte iba a estar enganchado para también tener esa referencia de medida:

<figure markdown="span">
  ![Imagen de Medida Mesa](../images/MT02/3.png){ width="600"}
</figure>
