...
Para la actividad del MT06, se nos solicitaba diseñar y desarrollar una interficie digital, la cual debería interaccionar con el usuario, como extra podíamos incluir la información de algun sensor, servicio externo o alguna fuente de datos, un ejercicio práctico para aplicar los conocimientos adquiridos en el módulo. 
...
*[Proyecto de Arduino IDE](../archives/EFDI_MT08_NDQ.rar)*
